...
### 🚀 重大版本更新
- **[#2865a527](https://github.com/google-gemini/gemini-cli/commit/2865a527)** - 📚 **配置选项文档** - 添加 showLineNumbers 选项到文档
- **[#0e44bbc8](https://github.com/google-gemini/gemini-cli/commit/0e44bbc8)** - 📖 **README 全面改版** - 提升清晰度和用户体验
- **[#0157eae3](https://github.com/google-gemini/gemini-cli/commit/0157eae3)** - ⚙️ **启用默认使用统计收集** - 修复设置中的默认使用统计收集
