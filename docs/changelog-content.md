...
### 2025-07-17 Update
- **Commit Range**: b3cbde5c..9ab44ea9
- **New Commits**: 66
- **Version**: v0.1.12

### 2025-07-16 Update
- **Commit Range**: ddcac420..34c1b581
- **New Commits**: 22
- **Version**: v0.1.12

### 2025-07-15 Update
- **Commit Range**: b09bc665..fadc4770
- **New Commits**: 18
- **Version**: v0.1.12

### 2025-07-14 Update
- **Commit Range**: e9d680e8..ef8ec984
- **New Commits**: 8
- **Version**: v0.1.12

### 2025-07-13 Update
- **Commit Range**: b018e2d3..890982a8
- **New Commits**: 8
- **Version**: v0.1.12

### 2025-07-12 Update
- **Commit Range**: 8f12e8a1..b3cbde5c
- **New Commits**: 15
- **Version**: v0.1.11

### 2025-07-11 Update
- **Commit Range**: cdbe2fff..bf508bfd
- **New Commits**: 15
- **Version**: v0.1.10

### 2025-07-10 Update
- **Commit Range**: 5ecc1372..b7f8e136
- **New Commits**: 4
- **Version**: v0.1.10
...
### 🔧 斜杠命令架构重构
- **[#4259](https://github.com/google-gemini/gemini-cli/pull/4259)** - 🔧 将 `/quit` Update到新的斜杠命令架构
- **[#4246](https://github.com/google-gemini/gemini-cli/pull/4246)** - 🔧 将 `/bug` Update到新的斜杠命令架构
- **[#4153](https://github.com/google-gemini/gemini-cli/pull/4153)** - 🔧 将 `/editor` Update到新的斜杠命令架构
- **[#4236](https://github.com/google-gemini/gemini-cli/pull/4236)** - 🔧 将 `/tools` Update到新的斜杠命令架构
- **[#4133](https://github.com/google-gemini/gemini-cli/pull/4133)** - 🔧 将 `/docs` Update到新的斜杠命令架构
...
- **[#4229](https://github.com/google-gemini/gemini-cli/pull/4229)** - 🔧 将 `/extensions` Update到新的斜杠命令架构
- **[#4146](https://github.com/google-gemini/gemini-cli/pull/4146)** - 🔧 将 `/stats` Update到新的斜杠命令架构
...
- **[#3797](https://github.com/google-gemini/gemini-cli/pull/3797)** - 🔧 将 '/auth' Update到新的斜杠命令架构
...
- **[#4311](https://github.com/google-gemini/gemini-cli/pull/4311)** - 🎨 IDE 模式的小幅 UX Update
...
### 🔧 模型和性能改进
- **[#4176](https://github.com/google-gemini/gemini-cli/pull/4176)** - 🔧 Update google/genai 到 v1.9.0 并切换到 parametersJsonSchema 用于 MCP 相关工具
...
- **[#2233](https://github.com/google-gemini/gemini-cli/pull/2233)** - 🔧 Update MaxSizedBox.tsx
...
- **[#4249](https://github.com/google-gemini/gemini-cli/pull/4249)** - 🔧 chore: Update release-docker.yaml 中的编号
...
### 🔧 其他改进
- **[#4252](https://github.com/google-gemini/gemini-cli/pull/4252)** - ⏪ 撤销 "Update到 yargs v18 (#3759)"
...
- **[#3759](https://github.com/google-gemini/gemini-cli/pull/3759)** - 🔧 Update到 yargs v18
...
### 🔧 发布和修复
- **[#4249](https://github.com/google-gemini/gemini-cli/pull/4249)** - 🔧 Update release-docker.yaml 中的编号
- **[#4241](https://github.com/google-gemini/gemini-cli/pull/4241)** - 📦 上传配套 VS Code 扩展的 VSIX
- **[#4252](https://github.com/google-gemini/gemini-cli/pull/4252)** - ⏪ 撤销 "Update到 yargs v18"
- **[#4244](https://github.com/google-gemini/gemini-cli/pull/4244)** - ⏪ 撤销 Node <20 警告
- **[#4240](https://github.com/google-gemini/gemini-cli/pull/4240)** - 🔧 在 header 中包含 api key 而不是在 URL 中
...
- **[#3042](https://github.com/google-gemini/gemini-cli/pull/3042)** - 📝 Update认证文档显示如何在 GCP 中使用 API 密钥
